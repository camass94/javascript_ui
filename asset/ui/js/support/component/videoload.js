define(['ic/ic', 'ic/ui/module'], function(ic, Module) {
    ...
    proto.appendVideo = function() {
        ...
        playerHTML = '<iframe src="//players.brightcove.net/' + self.options.account + '/' + self.options.player + '_default/index.html?videoId=' + self.options.videoId + '"title="' + self.options.title + '" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>';
