...
(function(global, factory) {
	...
	// Regex
	var rupper = /([A-Z])/g;
	var rsvg = /^https:[\w\.\/]+svg$/; //LGEGMO-4062
	...
	Panzoom.prototype = {
		...
		_setOptions: function(options) {
			$.each(options, $.proxy(function(key, value) {
				switch(key) {
					case 'disablePan':
						/* PJTPDP-11 20180223 modify kimwooram*/
						//this._resetStyle();
						/* //PJTPDP-11 20180223 modify kimwooram*/
		...
		_bind: function() {
			...
			/* //PJTPDP-11 20180223 modify kimwooram*/
			var str_down = 'mousedown' + ns + ' MSPointerDown' + ns;
			var str_start = 'touchstart' + ns + ' ' + str_down;
			/* PJTPDP-11 20180223 modify kimwooram*/
			//var str_click = 'touchend' + ns + ' click' + ns + ' pointerup' + ns + ' MSPointerUp' + ns;
			/* //PJTPDP-11 20180223 modify kimwooram*/
			var str_click = 'touchend' + ns + ' click' + ns + ' MSPointerUp' + ns;
			var events = {};
		...
		_startMove: function(event, touches) {
			...
			var setStart = function(event, touches) {
				/* PJTPDP-11 20180223 add kimwooram*/
			...
			var move = function(e) {
				...
				if (!coords) {
					/* PJTPDP-11 20180223 modify kimwooram*/
					//coords = e;
					coords = e.originalEvent;	// lg.com use
					/* //PJTPDP-11 20180223 modify kimwooram*/
				}
